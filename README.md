...
This is a sample template for lambda-wordpress-google-page-feed-generator - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name lambda-wordpress-google-page-feed-generator \
...
aws cloudformation describe-stacks \
    --stack-name lambda-wordpress-google-page-feed-generator --query 'Stacks[].Outputs'
```
